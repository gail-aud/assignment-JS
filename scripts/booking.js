...
function daysOfWeekSelected(event){
...
mondayButton.onclick = daysOfWeekSelected;
tuesdayButton.onclick = daysOfWeekSelected;
wednesdayButton.onclick = daysOfWeekSelected;
thursdayButton.onclick = daysOfWeekSelected;
fridayButton.onclick = daysOfWeekSelected;
